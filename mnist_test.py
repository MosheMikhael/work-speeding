# -*- coding: utf-8 -*-
"""
Created on Tue Oct 16 17:23:03 2018
...
train_loader = torch.utils.data.DataLoader(datasets.MNIST('input/mnist/', 
                                                          download=True, 
                                                          train=True,
...
test_loader = torch.utils.data.DataLoader(datasets.MNIST('input/mnist/', 
                                                          download=True, 
                                                          train=False,
                                                          transform=transforms.Compose([
                                                              transforms.ToTensor(), # first, convert image to PyTorch tensor
